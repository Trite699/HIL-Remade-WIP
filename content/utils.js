const extUtils = {
    ...
    messageListeners: {
        addMessageListenerAll: function(window, callback) {
    ...
    unknown: {
        ...
        testRegex: function(str, re) {
            const match = str.match(re);
            return match !== null && match[0] == match.input;
        },

        kindaRandomChoice: function(array, seed = null) {
        ...
        wait: function(duration = 0) {
            return new Promise(function(resolve) {
                setTimeout(resolve, duration);
            });
        },

        fixTagNesting: function(text) {
            REGEX_TAG = /\[#[^/[\]]*?\]$/
        ...
        compareShallow: function(a, b, keys) {
    ...
    theme: {
        getTheme: function() { 
            const themeInput = (this.unknown.getLabel("Dark Mode")  || this.unknown.getLabel("Light Mode")).parentElement.querySelector("input");
            if(themeInput.ariaChecked == "true") return {
                theme: 'theme--dark', 
                input: themeInput
            };
            return {
    ...
    text: {
        ...
        insertValue: function(elem, text, index) {
            if (document.activeElement == elem) {
    ...
    buttons: {
        createButton: function(listener, text, classText, styleText) {
        ...
        primaryButton: function(listener, classText, styleText, child) {
            const button = document.createElement('button');
        ...
        iconToggleButton: function(listenerCheck, text, classText, styleText, defaultEnabled = false) {
        ...
        createSwitch: function(onchange, def=false) {
    ...
    scripts: { 
        injectScript: function(src, type = null)  {
    ...
    dom: {
        getHTMLOfSelection: function() { // https://stackoverflow.com/questions/5083682/get-selected-html-in-browser-via-javascript
        ...
        verifyStructure: function(obj, structure) {
            if (!obj) obj = {};
    ...
    creation: {
        ...
        createTooltip: function(text, anchorElement) {
